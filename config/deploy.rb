...
server 'ec2-52-28-172-168.eu-central-1.compute.amazonaws.com', user: 'deploy', roles: %w{web app db}

set :repo_url,        'git@github.com:durman4ik/luxparfum.git'
...
set :linked_dirs,     %w(bin log tmp/pids tmp/cache tmp/sockets vendor/bundle public/system public/uploads shared/public )
...
#   end
# end
# after 'deploy', 'mongoid:copy'
# after 'deploy', 'mongoid:symlink'
# after 'deploy', 'mongoid:index'